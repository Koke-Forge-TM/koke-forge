...
export default function Footer() {
    return (<>
                    ...
                    <div className="max-w-6xl mx-auto px-4 sm:px-6">
                        ...
                        <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
                            ...
                            <div className="md:col-span-4 lg:col-span-5">
                                ...
                                <div className="text-gray-400">Lorem ipsum is placeholder text commonly used in the
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; KokeForge TM. All rights reserved. Template by cruip.com</div>
